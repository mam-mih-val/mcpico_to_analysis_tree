...
echo "/mnt/pool/nica/7/mam2mih/soft/basov/mcpico_to_analysis_tree/build/convert -i $filelist -o output.root --output-tree atree -s $colliding_system -e $collision_energy --sample-reaction-plane --$data_format"
...
input_list=\"list.txt\"
qa_output=\"qa.root\"
root -q "/scratch1/mmamaev/bmnroot/analysis/common/macro/run_tracking_qa.C( $input_list, $qa_output )"
...
/mnt/pool/nica/7/mam2mih/soft/basov/QnAnalysis/build/src/QnAnalysisCorrect/QnAnalysisCorrect \
                                                                          ...
                                                                          --yaml-config-file /mnt/pool/nica/7/mam2mih/soft/basov/mcpico_to_analysis_tree/qnanalysis/mc_corrections.yml \
...
/mnt/pool/nica/7/mam2mih/soft/basov/QnAnalysis/build/src/QnAnalysisCorrelate/QnAnalysisCorrelate \
                                                                              ...
                                                                              --configuration-file /mnt/pool/nica/7/mam2mih/soft/basov/mcpico_to_analysis_tree/qnanalysis/mc_correlations.yml \
