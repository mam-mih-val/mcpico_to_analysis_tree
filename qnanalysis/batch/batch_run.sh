...
/scratch1/mmamaev/QnAnalysis/build/src/QnAnalysisCorrect/QnAnalysisCorrect \
                                                                          ...
                                                                          --yaml-config-file /scratch1/mmamaev/mcpico_to_analysis_tree/qnanalysis/pT_weight_corrections.yml \
...
/scratch1/mmamaev/QnAnalysis/build/src/QnAnalysisCorrelate/QnAnalysisCorrelate \
                                                                              ...
                                                                              --configuration-file /scratch1/mmamaev/mcpico_to_analysis_tree/qnanalysis/pT_weight_correlations.yml \
